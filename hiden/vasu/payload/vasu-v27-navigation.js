...
function vasuV27InjectStyles(){
  ...
  const s=document.createElement('style');s.id='vasuV27NavStyles';s.textContent=`
    ...
    @media(max-width:820px){
      ...
      body.vasu-nav-open{overflow:hidden!important}
