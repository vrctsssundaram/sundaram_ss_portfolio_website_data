...
const pass=[];const fail=[];const check=(name,ok)=>{(ok?pass:fail).push(name)};
...
if(exists('app/shini/assets/shini-logo.png')){
  ...
  check('Master logo is PNG',b.subarray(0,8).equals(Buffer.from([137,80,78,71,13,10,26,10])));
  check('Master logo has meaningful payload',b.length>20000);
}
